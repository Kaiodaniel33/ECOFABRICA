document.addEventListener("DOMContentLoaded", () => {
    ...
    /* ==========================================================================
       DESCRIÇÃO: Funções utilitárias puras e reutilizáveis.
       ========================================================================== */
    const Helpers = {
    ...
    /* ==========================================================================
       DESCRIÇÃO: A "Inteligência" do Professor Sabiá.
       ========================================================================== */
    const SABIA_KNOWLEDGE_BASE = {
        gameTips: [
            { 
                condition: (s) => s.budget < 500,
                tip: "Seu orçamento está perigosamente baixo! Evite gastos grandes e foque em ações que gerem receita ou reduzam custos, como 'Otimizar Logística'." 
            },
            { 
                condition: (s) => s.waste > 60,
                tip: "O nível de desperdício está altíssimo! Isso gera custos e afeta sua reputação. Invista em 'Reciclagem Básica' ou 'Treinamento de Eficiência' urgente!" 
            },
            { 
                condition: (s) => s.morale < 40,
                tip: "A moral da equipe está em queda. Funcionários infelizes produzem menos. Considere 'Melhorar refeitório' ou uma Política de 'Lanches Grátis'." 
            },
            { 
                condition: (s) => s.sustainability < 20,
                tip: "Sua operação não é nada sustentável. A fiscalização pode bater na sua porta. 'Investir em Energia Solar' é caro, mas resolve isso a longo prazo."
            },
            { 
                condition: (s) => s.researchPoints > 15,
                tip: "Você acumulou muitos Pontos de P&D! Não os deixe parados. Pesquise novas tecnologias para desbloquear ações mais poderosas."
            },
            { 
                condition: (s) => s.marketPriceModifier > 1.3,
                tip: `O mercado está pagando ${((s.marketPriceModifier-1)*100).toFixed(0)}% a mais! Sua produção vale ouro! Excelente hora para focar em 'Produção'.`
            },
            { 
                condition: (s) => s.marketPriceModifier < 0.9,
                tip: "O mercado está em baixa... Estamos recebendo menos pelos produtos. Talvez seja hora de focar em cortar custos e desperdício, em vez de expandir a produção."
            },
            { 
                condition: (s) => s.currentMonth === 1,
                tip: "Primeiro mês! Analise seu perfil de gestor. Se você é 'Visionário Verde', sua prioridade é Sustentabilidade, não apenas lucro." 
            },
            { 
                condition: (s) => s.currentMonth === 6,
                tip: "Estamos no meio do ano. É um bom momento para checar o Relatório de Desempenho e ver sua evolução. Ajuste sua estratégia!" 
            },
            {
                condition: (s) => s.currentMonth === 11,
                tip: "Reta final! Se você está longe da sua meta, talvez precise de uma ação de 'alto risco, alta recompensa'. Boa sorte!"
            }
        ],
        ...
        quizQuestions: [
            {
                area: "HTML",
                question: "Qual tag HTML é usada para o *conteúdo principal* de uma página, ajudando na semântica e acessibilidade?",
                options: ["<div class='main'>", "<main>", "<content>", "<body-content>"],
                answer: "<main>",
                explanation: "<main> é a tag semântica correta. Leitores de tela usam ela para pular direto ao conteúdo principal."
            },
            {
                area: "HTML",
                question: "Para que serve o atributo 'for' em uma tag <label>?",
                options: ["Para criar um loop 'for'", "Para conectar o label a um 'id' de um <input>", "Para definir a fonte do texto", "Para uso em formulários de 'for'necedores"],
                answer: "Para conectar o label a um 'id' de um <input>",
                explanation: "O 'for' no <label> é vinculado ao 'id' do <input>, melhorando a acessibilidade e a usabilidade (clicar no label foca o input)."
            },
            {
                area: "HTML",
                question: "O que significa o atributo 'data-profile' que usamos nos botões de perfil?",
                options: ["Define o CSS do perfil", "É um atributo de dados ('data attribute') para guardar informações customizadas", "É um link para o perfil do usuário", "Não tem função, é apenas um comentário"],
                answer: "É um atributo de dados ('data attribute') para guardar informações customizadas",
                explanation: "Data attributes (começam com 'data-') são uma forma padrão de armazenar dados no HTML para serem lidos pelo JavaScript."
            },
            {
                area: "CSS",
                question: "O que 'box-sizing: border-box;' faz?",
                options: ["Coloca uma borda em todas as caixas", "Calcula o tamanho da caixa incluindo padding e border na largura/altura total", "Calcula o tamanho da caixa somando padding e border à largura/altura", "Centraliza a caixa na página"],
            ...
            {
                area: "CSS",
                question: "Qual a *vantagem* de usar Variáveis CSS (ex: '--color-primary')?",
                options: ["Deixa o CSS mais rápido", "É a única forma de usar cores", "Permite mudar um valor (ex: uma cor) em um só lugar e atualizar o site inteiro", "Funciona em navegadores antigos como o IE6"],
                answer: "Permite mudar um valor (ex: uma cor) em um só lugar e atualizar o site inteiro",
                explanation: "Variáveis centralizam seus valores de design ('tokens'). Mude a variável '--color-primary' e todos os elementos que a usam mudam instantaneamente."
            },
            {
                area: "CSS",
                question: "No CSS Grid, o que 'repeat(auto-fit, minmax(200px, 1fr))' significa?",
                options: ["Cria 200 colunas", "Repete o layout 1 vez", "Cria colunas de 200px que não crescem", "Cria o máximo de colunas que couberem, com no mínimo 200px, e distribui o espaço extra (1fr)"],
                answer: "Cria o máximo de colunas que couberem, com no mínimo 200px, e distribui o espaço extra (1fr)",
                explanation: "É uma das regras mais poderosas do CSS Grid para criar layouts responsivos automaticamente, sem precisar de media queries!"
            },
            {
                area: "JS",
                ...
                explanation: "Isso previne erros! Se o JS rodar antes do HTML, ele pode tentar achar um botão (ex: 'start-button') que *ainda não existe* e quebrar."
            },
            {
                area: "JS",
                question: "Qual a diferença entre 'let' e 'const'?",
                options: ["'let' é para números, 'const' é para texto", "'let' pode ter seu valor reatribuído, 'const' não pode", "'const' é mais rápido que 'let'", "Não há diferença, são a mesma coisa"],
                answer: "'let' pode ter seu valor reatribuído, 'const' não pode",
                explanation: "'const' (constante) cria uma variável que não pode ser reatribuída. 'let' cria uma variável que pode. Regra de ouro: use 'const' sempre, a menos que você *precise* mudar o valor, aí use 'let'."
            },
            {
                area: "JS",
                question: "Para que serve a 'Intl.NumberFormat('pt-BR', ...)' que usamos?",
                options: ["Para formatar números internacionais", "Para formatar números e moedas no padrão correto de uma língua (ex: R$ 1.234,56)", "Para traduzir a página", "Para calcular impostos"],
                answer: "Para formatar números e moedas no padrão correto de uma língua (ex: R$ 1.234,56)",
                explanation: "'Intl' (Internationalization) é a API nativa do JS para lidar com formatos de data, hora e números em diferentes locais do mundo."
            },
            {
                area: "JS",
                question: "O que é uma 'Classe' (como 'class Game' que usamos)?",
                options: ["Um arquivo de CSS", "Uma 'planta' ou 'molde' para criar objetos com as mesmas propriedades e métodos", "Uma função que roda sozinha", "Um tipo de comentário"],
                answer: "Uma 'planta' ou 'molde' para criar objetos com as mesmas propriedades e métodos",
                explanation: "A 'class Game' é o molde. Quando fazemos 'new Game()', criamos um *objeto* (uma 'instância') daquele molde, que já vem com 'state', 'ui', 'sabia', e os métodos 'advanceMonth()', etc."
            },
            {
                area: "JS",
                question: "Por que separamos o código em classes como 'Game', 'State' e 'UI'?",
                options: ["Porque é obrigatório pelo navegador", "Para o código ficar mais longo", "Chama-se 'Separação de Preocupações' (SoC). Cada classe tem UMA responsabilidade, facilitando a manutenção.", "Para confundir quem está lendo"],
                answer: "Chama-se 'Separação de Preocupações' (SoC). Cada classe tem UMA responsabilidade, facilitando a manutenção.",
                explanation: "A 'UI' só mexe no HTML. A 'State' só guarda dados. O 'Game' orquestra tudo. Se o layout quebrar, mexemos só na 'UI'. Se o cálculo de lucro estiver errado, mexemos só na 'State'. Isso é arquitetura sólida!"
            }
        ]
    };
    ...
    /* ==========================================================================
       DESCRIÇÃO: A definição de TODO o conteúdo do jogo.
       ========================================================================== */
    const GAME_DATA = {
        totalMonths: 12,
        ...
        statDisplayNames: {
            budget: "Orçamento",
            production: "Produção/mês",
            waste: "Desperdício/mês",
            sustainability: "Sustentabilidade",
            morale: "Moral da Equipe",
            reputation: "Reputação",
            researchPoints: "Pontos P&D",
            land: "Área Agrícola (ha)",
            marketPriceModifier: "Preço de Mercado"
        },
        
        profiles: {
            visionario: {
                name: "Visionário Verde 🌎",
                description: "Sua gestão foi um exemplo para o Paraná! Você provou que é possível prosperar cuidando do planeta.",
                winCondition: (s) => s.sustainability >= 100 && s.reputation >= 90,
                getWinMessage: (s) => `PARABÉNS! Você atingiu ${s.sustainability} de Sustentabilidade e ${s.reputation} de Reputação!`
            },
            capitalista: {
                name: "Capitalista Consciente 💰",
                description: "Resultados financeiros impressionantes! Você soube aliar lucro com responsabilidade.",
                winCondition: (s) => s.budget >= 5000 && s.sustainability >= 60,
                getWinMessage: (s) => `PARABÉNS! Você atingiu ${Helpers.formatCurrency(s.budget)} em caixa e ${s.sustainability} de Sustentabilidade!`
            },
            lider: {
                name: "Líder Comunitário 👨‍👩‍👧‍👦",
                description: "Sua fábrica é o orgulho da comunidade! Sua gestão focada em pessoas e reputação criou um ambiente exemplar.",
                winCondition: (s) => s.morale >= 100 && s.reputation >= 95,
                getWinMessage: (s) => `PARABÉNS! Você atingiu ${s.morale} de Moral e ${s.reputation} de Reputação!`
            }
        },
        ...
        researchTree: {
            t1_basic_recycling: {
                ...
                label: "P&D: Reciclagem Básica",
                costRP: 5,
                description: "Estuda métodos simples de separação e reuso de resíduos.",
            ...
            t1_efficiency_studies: {
                ...
                label: "P&D: Estudos de Eficiência",
                costRP: 5,
                description: "Analisa o fluxo de trabalho para reduzir desperdício de tempo e material.",
            ...
            t1_local_marketing: {
                ...
                label: "P&D: Marketing Comunitário",
                costRP: 3,
                description: "Entende como melhorar a imagem da fábrica na comunidade local.",
            ...
            t2_water_optimization: {
                ...
                label: "P&D: Otimização de Água",
                costRP: 10,
                description: "Pesquisa sobre reuso de água e sistemas de irrigação eficientes.",
                effects: { sustainability: 5 },
            ...
            t2_green_energy: {
                ...
                costRP: 12,
                description: "Analisa a viabilidade de painéis solares e outras fontes limpas.",
                effects: {},
            ...
            t2_hr_development: {
                ...
                costRP: 8,
                description: "Estuda políticas de bônus, saúde e bem-estar para a equipe.",
                effects: { morale: 5 },
            ...
            t2_supply_chain: {
                id: 't2_supply_chain',
                label: "P&D: Logística de Suprimentos",
                costRP: 10,
                description: "Otimiza a compra de matéria-prima e logística de entrada.",
                effects: {},
            ...
            t3_advanced_recycling: {
                ...
                label: "P&D: Reciclagem Avançada",
                costRP: 20,
                description: "Desenvolve tecnologia para 'lixo zero', transformando resíduos em sub-produtos.",
            ...
            t3_automation: {
                id: 't3_automation',
                label: "P&D: Automação de Linha",
                costRP: 25,
                description: "Implementa robôs para acelerar a produção (cuidado com a moral!).",
            ...
            t4_carbon_capture: {
                ...
                costRP: 40,
                description: "Tecnologia experimental para tornar a fábrica carbono-negativo.",
            ...
            t4_ai_optimization: {
                ...
                label: "P&D: Otimização por IA",
                costRP: 35,
                description: "Usa IA para prever demanda de mercado e otimizar a produção em tempo real.",
                effects: { production: 10 },
        ...
        actions: {
            action_optimize_logistics: {
                ...
                category: 'Operações',
                label: "Otimizar Logística de Entrega",
                cost: 200,
                description: "Revisar rotas de entrega para economizar combustível e tempo.",
                effects: {},
            ...
            action_implement_basic_recycling: {
                ...
                category: 'Operações',
                label: "Implementar Reciclagem Básica",
                cost: 300,
                description: "Instala lixeiras de separação e processos de reuso.",
            ...
            action_install_solar_panels: {
                ...
                cost: 1000,
                description: "Cobre 30% da demanda de energia com painéis solares.",
            ...
            action_local_suppliers: {
                ...
                cost: 250,
                description: "Reduz custo de frete e melhora a reputação local.",
            ...
            action_zero_waste_plant: {
                ...
                cost: 2500,
                description: "Investimento massivo para eliminar 100% do desperdício.",
            ...
            action_automate_production_line: {
                ...
                category: 'Operações',
                label: "Automatizar Linha de Produção",
                cost: 2000,
                description: "Aumenta drasticamente a produção, mas pode reduzir a moral.",
            ...
            action_carbon_capture_filters: {
                ...
                cost: 3000,
                description: "Torna a fábrica carbono-negativo, um feito de RP e sustentabilidade.",
            ...
            action_ai_logistics: {
                ...
                category: 'Operações',
                label: "Implementar Logística por IA",
                cost: 1500,
            ...
            action_improve_breakroom: {
                ...
                label: "Melhorar Refeitório",
                cost: 150,
                description: "Café de melhor qualidade e um espaço mais confortável.",
            ...
            action_team_training_efficiency: {
                ...
                category: 'Recursos Humanos',
                label: "Capacitar Equipe (Eficiência)",
                cost: 250,
                description: "Treinamento para reduzir desperdício na linha de produção.",
            ...
            action_profit_sharing_plan: {
                ...
                category: 'Recursos Humanos',
                label: "Plano de Participação nos Lucros",
                cost: 500,
            ...
            action_health_plan: {
                ...
                category: 'Recursos Humanos',
                label: "Oferecer Plano de Saúde Básico",
                cost: 300,
                description: "Plano de saúde para todos os funcionários.",
                effects: { morale: 20 },
            ...
            action_buy_more_land: {
                ...
                cost: 300,
                description: "Expande a área agrícola, aumentando o potencial de produção.",
            ...
            action_protect_from_frost: {
                ...
                cost: 400,
                description: "Protege a plantação de geadas, reduzindo perdas.",
                effects: { sustainability: 5 },
                unlocksFlag: 'frostProtection',
                requiredTech: []
            },
            ...
            action_sponsor_local_team: {
                ...
                cost: 200,
                description: "Coloca o logo da fábrica na camiseta do time de futebol da cidade.",
            ...
            action_community_open_day: {
                ...
                category: 'Comunidade',
                label: "Dia de Fábrica Aberta",
                cost: 100,
                description: "Convida a comunidade para visitar a fábrica.",
                effects: { reputation: 10 },
                requiredTech: ['t1_local_marketing']
            },
            action_national_marketing_campaign: {
                ...
                cost: 1500,
                description: "Torna a 'EcoFábrica' uma marca reconhecida no Brasil.",
            ...
            action_policy_snacks: {
                ...
                category: 'Políticas',
                label: "Política: Lanches Grátis",
                cost: 100, 
                description: "Implementa lanches. Custo recorrente de $50/mês.",
                effects: { morale: 5 },
            ...
            action_policy_overtime: {
                ...
                category: 'Políticas',
                label: "Política: Horas Extras Pagas",
                cost: 0, 
                description: "Aumenta a produção. Custo recorrente de $100/mês.",
                effects: { production: 10, morale: -5 },
                monthlyEffects: { budget_expense: 100, production: 5, morale: -2 },
                requiredTech: ['t1_efficiency_studies']
            },
            action_policy_preventive_maintenance: {
                id: 'action_policy_preventive_maintenance',
                category: 'Políticas',
                label: "Política: Manutenção Preventiva",
                cost: 200, 
                description: "Reduz o desperdício. Custo recorrente de $75/mês.",
                effects: { waste: -5 },
        ...
        events: [
            {
                ...
                message: "Uma frente fria intensa vinda do Sul ameaça congelar sua produção agrícola. Suas plantações estão vulneráveis!",
                choices: [
                    { text: "Sofrer o impacto total", effects: { production: -20, budget: -150 }, log: "A geada foi devastadora. Perdemos parte da produção." },
            ...
            },
            {
                ...
                message: "A falta de chuva no Paraná está crítica, afetando o nível dos reservatórios e sua produção.",
                choices: [
                    { text: "Aceitar consequências", effects: { production: -15, waste: 5, budget: -100 }, log: "A estiagem impactou a produção e aumentou os custos." }
                ]
            },
            {
                id: "FISCALIZACAO",
                ...
                message: "Fiscais do Instituto Água e Terra (IAT) estão na fábrica. Eles encontraram irregularidades no descarte de resíduos.",
                choices: [
                    { text: "Pagar multa e se adequar ($300)", cost: 300, effects: { reputation: -10, sustainability: -5 }, log: "Multa paga. Tivemos que nos adequar às pressas." },
                    { text: "Negociar um Termo de Ajuste ($100)", cost: 100, effects: { reputation: -5 }, log: "Negociamos um TAC. A multa foi baixa, mas a reputação sofreu um pouco." }
                ]
            },
            {
                id: "EQUIPE_DOENTE",
                ...
                choices: [
                    { text: "Contratar temporários ($200)", cost: 200, effects: { production: -5, morale: -5 }, log: "Contratamos temporários, mas a produção caiu e a equipe ficou sobrecarregada." },
                    { text: "Absorver a perda", effects: { production: -15, morale: -10, budget: -50 }, log: "Não fizemos nada e a produção do mês foi muito prejudicada." }
                ]
            },
            {
                id: "PRAGA_LAVOURA",
                ...
                message: "Uma praga de gafanhotos atingiu parte da sua área agrícola!",
                choices: [
                    { text: "Contratar controle de pragas ($250)", cost: 250, effects: { production: -5, sustainability: -5 }, log: "O controle de pragas (com agrotóxicos) resolveu, mas afetou nossa sustentabilidade." },
                    { text: "Usar controle biológico ($400)", cost: 400, effects: { production: -5, sustainability: 5, reputation: 5 }, log: "O controle biológico foi caro, mas efetivo e melhorou nossa imagem." },
            ...
            },
            {
                ...
                title: "Maquinário Essencial Quebrou!",
                condition: (s) => s.production > 70 && !s.unlockedActions.includes('action_policy_preventive_maintenance') && Math.random() < 0.3,
                message: "A principal linha de produção parou por falta de manutenção! Precisamos de um reparo emergencial.",
                choices: [
                    { text: "Reparo de Emergência ($500)", cost: 500, effects: { production: -10, morale: -5 }, log: "O reparo foi caro e atrasou a produção do mês." },
                ]
            },
            {
                id: "FORNECEDOR_FALHA",
                title: "Fornecedor de Matéria-Prima Faliu!",
                condition: (s) => s.currentMonth > 4 && !s.unlockedActions.includes('action_local_suppliers') && Math.random() < 0.2,
                message: "Nosso principal fornecedor de matéria-prima fechou as portas! Teremos que achar um substituto mais caro às pressas.",
                choices: [
                    { text: "Pagar mais caro este mês ($300)", cost: 300, effects: { production: -5 }, log: "Achamos um substituto, mas o custo impactou o orçamento." }
                ]
            },
            
            {
                ...
                message: "Um jornal local fez uma reportagem elogiando as práticas sustentáveis da EcoFábrica! O público adorou.",
                choices: [
                    { text: "Agradecer e continuar", effects: { reputation: 15, morale: 10, marketPriceModifier: 0.1 }, log: "A reportagem positiva aumentou nossa reputação e o preço dos produtos!" }
                ]
            },
            {
                id: "INOVACAO_INTERNA",
                ...
                message: "Com a equipe motivada, um funcionário sugeriu uma pequena mudança no processo que pode economizar muito!",
                choices: [
                    { text: "Implementar e dar bônus ($100)", cost: 100, effects: { morale: 10, researchPoints: 5, waste: -10 }, log: "A ideia foi um sucesso e a equipe se sente valorizada!" },
                    { text: "Implementar e ignorar o funcionário", effects: { morale: -15, researchPoints: 5, waste: -10 }, log: "A ideia funcionou, mas a equipe ficou desmotivada por não ser reconhecida." }
                ]
            },
            {
                id: "SAFRA_RECORDE",
                ...
                choices: [
                    { text: "Vender o excedente (+$400)", cost: -400, effects: { production: 10, waste: 5 }, log: "Safra recorde! Ganhamos um bônus de $400, mas parte se perdeu no armazenamento." }
                ]
            },
            {
                ...
                message: "Um funcionário treinado se destacou, otimizando sozinho uma pequena área da fábrica.",
                choices: [
                    { text: "Promovê-lo a supervisor ($150)", cost: 150, effects: { morale: 10, production: 10 }, monthlyEffects: { budget_expense: 50 }, log: "Novo supervisor! A equipe está motivada e a produção melhorou." },
                    { text: "Dar um bônus único ($100)", cost: 100, effects: { morale: 5, production: 5 }, log: "O funcionário ficou feliz com o bônus." }
                ]
            },
            {
                id: "VISITA_ESCOLA",
                ...
                message: "Uma escola local quer trazer os alunos para conhecerem a 'fábrica ecológica' da cidade.",
                choices: [
                    ...
                    { text: "Recusar (sem custo)", effects: { reputation: -5 }, log: "Recusamos a visita, o que gerou comentários negativos na comunidade." }
                ]
            }
        ]
    };
    ...
    /* ==========================================================================
       DESCRIÇÃO: Classe que gerencia TODO o estado (dados) do jogo.
       ========================================================================== */
    class GameState {
        constructor() {
        ...
        getFinalMessage(isBankruptcy) {
            if (isBankruptcy) {
                return `Que pena... A ECOFÁBRICA faliu no Mês ${this.currentMonth}. Mas não desanime, toda jornada tem seus tropeços. Tente novamente!`;
            }
            ...
            if (didWin) {
                ...
                return `PARABÉNS, ${this.playerName}! Você atingiu sua meta como ${profile.name}! ${winMsg} ${profile.description}`;
            } else {
                return `A gestão foi um grande aprendizado, ${this.playerName}. Você não atingiu a meta de ${profile.name}, mas cada desafio ensina. Tente novamente!`;
            }
        }
    }
    ...
    /* ==========================================================================
       DESCRIÇÃO: Classe que gerencia TODA a interação com o DOM (HTML).
       ========================================================================== */
    class GameUI {
        constructor() {
            this.dom = {
        ...
        toggleMusic(forcePlay = false) {
            if (forcePlay && !this.isMusicPlaying) {
                ...
                this.dom.music.audio.play().catch(e => console.warn("Música aguardando interação do usuário."));
                this.dom.music.toggleBtn.textContent = '🎵';
        ...
        renderActions(state) {
            this.dom.decisionsColumn.innerHTML = ''; 
        ...
        createActionButton(item, type, state) {
            ...
            let reason = "";
            if (state.budget < cost) reason = "Orçamento insuficiente";
            ...
            if(costStr === '') costStr = 'Grátis';

            let monthlyCostStr = '';
            if(item.monthlyEffects && item.monthlyEffects.budget_expense > 0) {
                monthlyCostStr = ` (Recorrente: ${Helpers.formatCurrency(item.monthlyEffects.budget_expense)}/mês)`;
            }
        ...
        updateSabiaTip(title, text) {
            ...
            void this.dom.sabiaMentorBox.offsetWidth; 
            ...
            options.forEach(optionText => {
                ...
                button.onclick = () => {
                    ...
                    this.dom.sabiaQuizFeedback.innerHTML = isCorrect ?
                        ...
                        `<span class="u-text-danger"><strong>Quase!</strong> A resposta correta é <strong>${quiz.answer}</strong>. ${quiz.explanation}</span>`;
        ...
        renderReportChart(history) {
            ...
            if (history.budget.length === 0) {
                this.dom.chartContainer.innerHTML = "<p>Nenhum dado para exibir. Avance pelo menos um mês.</p>";
                return;
            }
            ...
            for (let i = 0; i < history.budget.length; i++) {
                ...
                monthWrapper.appendChild(createBar('budget', history.budget[i], maxBudget, 'Orçamento'));
                monthWrapper.appendChild(createBar('sustainability', history.sustainability[i], maxSustain, 'Sustentabilidade'));
                monthWrapper.appendChild(createBar('waste', history.waste[i], maxWaste, 'Desperdício'));

                const label = document.createElement('span');
                label.className = 'c-chart-bar__label';
                label.textContent = `Mês ${i + 1}`;
    ...
    class ProfessorSabia {
        ...
        log(message, type = 'sabia') {
            const s = `<strong>Professor Sabiá:</strong> "${message}"`;
            this.ui.addLog(s, type);
        }
        
        greet(playerName, profileName) {
            this.log(`Olá, ${playerName}! Um ${profileName}, hein? Uma escolha audaciosa! Sua jornada na EcoFábrica começa agora. Estou aqui para ajudar!`);
        }
        
        giveContextualTip(state) {
            let tipToShow = "As coisas parecem estáveis. Continue com o bom planejamento!";
            let tipTitle = "Relatório do Professor Sabiá";
            ...
            if (problemTip) {
                ...
                tipTitle = "🦉 Alerta do Professor Sabiá!";
            } else {
                const genericTips = [
                    "Não se esqueça de investir em P&D! O conhecimento de hoje é o lucro de amanhã.",
                    "Manter a Moral da Equipe alta resulta em mais Pontos de P&D passivos.",
                    "Reputação alta pode aumentar o preço dos seus produtos. Fique de olho!",
                    "Desperdício não é só ruim para o planeta, ele gera custos diretos todo mês!"
                ];
                tipToShow = Helpers.getRandomItem(genericTips);
                tipTitle = "🦉 Dica do Professor Sabiá";
            }
        ...
        attemptToAskQuiz(state, gameInstance) {
            ...
            if (state.currentMonth > this.lastQuizMonth + 1 && Math.random() < 0.3) {
                ...
                if (question) {
                    this.log("Vamos fazer uma pausa rápida para testar seu conhecimento de código!");
        ...
        logQuizResult(isCorrect) {
            if (isCorrect) {
                this.log("Parabéns, resposta correta! Você ganhou +3 Pontos de P&D como bônus!", 'good');
            } else {
                this.log("Quase! Mas não se preocupe, o importante é aprender. Continue estudando o código!", 'bad');
            }
        }
    }
    ...
    /* ==========================================================================
       DESCRIÇÃO: O "Motor" central do Jogo (Controlador).
       ========================================================================== */
    class Game {
        constructor() {
        ...
        advanceMonth(isFirstMonth = false) {
            ...
            if (!isFirstMonth) {
                ...
                this.ui.addLog(`Mês fechado. Receita: ${Helpers.formatCurrency(summary.income)}, Custos: ${Helpers.formatCurrency(summary.expenses)}. Lucro/Prejuízo: ${Helpers.formatCurrency(summary.profit)}.`, 'neutral');
            } else {
        ...
        handleAction(actionId) {
            ...
            this.ui.addLog(`Ação realizada: ${action.label} (Custo: ${Helpers.formatCurrency(action.cost || 0)})`, 'good');
        ...
        handleResearch(techId) {
            ...
            this.ui.addLog(`Pesquisa concluída: ${tech.label} (Custo: ${tech.costRP} P&D)`, 'good');
            this.ui.render(this.state.get(), this.state.history, this.isEventActive);
        }
